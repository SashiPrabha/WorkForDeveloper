...
<c:set var="contextRoot" value="${pageContext.request.contextPath}"/>
         <!-- sidebar start here -->
         <% HttpSession dev_session=request.getSession(); 
         	String dev_email=(String)session.getAttribute("dev_email");
         	String dev_name=(String)session.getAttribute("dev_name");
         %>
				...
				<div id="sidebar" class="sidebar   responsive  sidebar-fixed ace-save-state">
						<div style="text-align: center; margin-bottom: -10px!important; " class="login_as"> 
							...
							<h4><%=dev_email%><i class="fa fa-sign-out" style="color: red;"></i></h4>
						</div>
					...
					<ul class="nav nav-list">
						...
						<li class="" id="org">
							...
							<ul class="submenu">
								<li class="" id="">
									<a href="${contextRoot }/Project/NewProject" class="">
								...
								<li class="">
									<a href="${contextRoot}/student/viewAll?email=${developer.email}">
										<i class="menu-icon fa fa-caret-right"></i>
										View Students
										<b class="arrow fa fa-angle-right"></b>
									</a>
