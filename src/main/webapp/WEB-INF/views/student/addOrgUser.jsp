...
<!-- form starts from here -->
							<form:form class="form-horizontal" action="post" modelAttribute="developerProject">
								<div class="col-lg-6">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<form:input type="text" class="form-control" id="name"
												placeholder="Enter Project Title ..." required="" path="name"
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<form:input type="date" class="form-control"
												placeholder="Enter Last Date to be Accepted..."
												path="last_date"
								...
								<div class="col-lg-6">
									<div class="form-group">
										...
										<div class="col-sm-10">
											<textarea rows="11" cols="57" path="specification"
												id="specification"
