			...
			<div id="myTabContent" class="tab-content">
					...
					<form:form class="form-horizontal" action="developer/register" modelAttribute="developer" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<form:input type="email" class="form-control" id="demail" 
									placeholder="Enter Your Email.." path="email" required=""/>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<form:input type="password" class="form-control" id="dpassword"
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<form:input type="number" class="form-control" id="dmob"
					...
					<div class="panel panel-default">
						<div class="panel-body" style="height: 405px !important;">
							<div class="first_div">
								<div class="name_div">
									<p>
										&mdash;** Go Online With us ** &mdash; <span> Work For Developer</span> &mdash; ${comp} &mdash;
									</p>
								</div>
			...
			<form:form class=" login_form" action="login" onsubmit="return validate()" modelAttribute="login" method="post">
									<div class="form-group  has-feedback">
										<form:select class="form-control" name="role" path="role" autofocus="autofocus">
											<option value="NONE"  selected="selected">--- Select Login Option ---</option>
...
<div class="alert alert-success" style="margin-bottom:-12px;">
  <strong>${message} </strong>
		...
		<div class="footer_div navbar-fixed-bottom ">
			<div class="hr hr-double hr-dotted hr18"></div>
			<h4>
				My Application © 2017-2018 <small> 
				</small>
			</h4>
		</div>
